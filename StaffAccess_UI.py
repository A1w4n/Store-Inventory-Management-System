...
class StaffAccessPage(QWidget):
    ...
    def _build_ui(self):
        ...
        page_title.setStyleSheet("font-size: 38px; font-weight: 700; color: #111827;")
    ...
    def _build_qr_card(self) -> QFrame:
        ...
        badge.setStyleSheet("""
            ...
            background-color: #eef2ff; border-radius: 20px; padding: 4px 14px;
        """)
    ...
    def _build_instructions_card(self) -> QFrame:
        ...
        for num, color, text in steps:
            ...
            step_frame.setStyleSheet(f"""
                QFrame {{ background-color: #fafafa; border-radius: 10px; border: 1px solid #e5e7eb; }}
                QLabel {{ border: none; }}
            """)
            ...
            circle.setStyleSheet(f"""
                ...
                font-size: 16px; font-weight: 800; border-radius: 18px;
            """)
